                    ...
                    <?php foreach ($allPostits as $postit) { ?>
                        <div class="post-it">
                            <a href="index.php?page=PostitDetail&id=<?php echo $postit['IDPOSTIT']; ?>">
                                <h3>
                                    <?php echo htmlspecialchars($postit['TITRE'], ENT_QUOTES, 'UTF-8'); ?>
                                </h3>
                            </a>
                            <p>
                                <?php echo nl2br(htmlspecialchars($postit['LIBELLE'], ENT_QUOTES, 'UTF-8')); ?>
                            </p>
                            <h4>Créé le:
                                <?php echo htmlspecialchars($postit['DATEDECREATION'], ENT_QUOTES, 'UTF-8'); ?>
                            </h4>
            ...
            <div class="post-it-container" id="post-it-container-shared">
                <?php foreach ($sharedPostits as $postit): ?>
                    <div class="post-it">
                        ...
                        <h4>Propriétaire:
                            <?php echo htmlspecialchars($postit['PSEUDO']); ?>
                        </h4>
                    </div>
                <?php endforeach; ?>
            </div>
