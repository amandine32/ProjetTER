    ...
    <div class="register-container">
        ...
        <form id="registrationForm" action="index.php?page=register" method="post">
            ...
            <div>
                ...
                <input type="text" id="nom" name="nom" required placeholder="Saisisez votre Nom"
                    style="width: 250px;"><br>

                <label for="prenom">Prénom :</label>
                <input type="text" id="prenom" name="prenom" required placeholder="Saisisez votre Prénom"
                    style="width: 250px;"><br>

                <label for="pseudo">Pseudo :</label>
                <input type="text" id="pseudo" name="pseudo" required placeholder="Saisisez votre pseudo"
                    style="width: 250px;"><br>
                ...
                <input type="password" id="motdepasse" name="motdepasse" required placeholder="Au moins 6 caractères"
                    style="width: 250px;"><br>
                ...
                <label for="reponseSec">Réponse à la question secrète :</label>
                <input type="text" id="reponseSec" name="reponseSec" required placeholder="Votre réponse"><br>
